...
SELECT title Título FROM series Séries;
...
SELECT title, rating, awards, release_date FROM movies WHERE rating > 3 AND awards > 1 AND release_date BETWEEN '19880101' AND '20091231';